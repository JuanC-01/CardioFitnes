...
export default function ModalRegistro({ open, onClose, onSave, onCancel, editedFields, setEditedFields, errors,
                        ...
                        <Grid item xs={8}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={6}>
                                    <TextField
                                        label="Cantidad"
                                        value={editedFields.cantidad || ''}
                                        onChange={(e) => setEditedFields({ ...editedFields, cantidad: e.target.value.toUpperCase() })}
                                        fullWidth
                                        disabled={!isEditable}
                                    />
                                </Grid>                            
